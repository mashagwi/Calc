/**@mainpage
* SmartСalc — это приложение, которое позволяет вычислять некоторые
* математические выражения.

* Этот калькулятор состоит из трех разделов. Для переключения режимов выберите
* нужную вкладку в левой части экрана.
* 1. Калькулятор
...
* Для установки программы запустите команду make install.
* Для удаления программы воспользуйтесь make uninstal.
*
* Для удаления всех промежуточных файлов воспользуйтесь командой make clean.
